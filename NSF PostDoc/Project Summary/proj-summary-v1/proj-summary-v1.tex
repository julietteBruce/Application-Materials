...
\noindent \textbf{Overview.} The PI proposes to study questions in commutative algebra, algebraic geometry, and arithmetic geometry. Two projects involve studying homological questions in algebraic geometry and commutative algebra. A third project lies at the intersection of algebraic geometry and arithmetic geometry, and seeks to better understand how classical algebraic geometry results can be generalized when working over finite fields. 

\noindent \textbf{Intellectual Merit.} The PI's first project seeks to expand our understanding of syzygies of algebraic varieties from both the asymptotic and computational perspectives. Further, by using using new advances in high performance computing and numerical linear algebra this project will generate new data regarding the syzygies of Hirzebruch surfaces. This data will be publicly disseminated via the only syzygy database \textit{syzygydata.com} maintained by the PI. 

A second project proposed to by the PI seeks to extend our understanding of curves in toric 3-folds (e.g. $\P^1\times\P^2$) by generalizing existing results about the liaison theory of curves in $\P^3$. This project seeks to make use of new understandings on the homological properties of varieties embedded in spaces other than $\P^n$. This project will hopefully yield applications to both the theory of liaison, as well as, the study of the geometry of various moduli spaces of curves. 


The third project the PI proposes seeks to build upon recent generalizing classical Bertini Theorems in algebraic geometry to the setting of finite fields. More specifically, this project hopes to prove more general uniform Bertini Theorems over finite fields. Such results will hopefully shed light on both the geometry and arithmetic of varieties of finite fields, and potentially prove useful in studying things like rational points on varieties. 

\noindent \textbf{Broader Impacts.} As a LGBTQ women the PI has worked hard to promote diversity, inclusivity, and justice in the mathematical community. This proposal will further the PI's work in this direction by her continued involvement in as a mentor to multiple undergraduate women via the Association for Women in Mathematics's mentor network. The PI would also plans to try to mentor undergraduates via the Berkeley Directed Reading Program and the MSRI-Up program. 

At the 2018 Joint Mathematica Meeting the PI served on a panel organized by \textit{Spectra}, the association of LGBTQ+ mathematicians, titled \textit{Professional Issues Facing LGBTQ Mathematician}. At the 2020 Joint Meetings the PI is organizing a \textit{Spectra} panel on making mathematics more inclusive for transgender mathematicians. Going forward the PI plans to continue being involved in \textit{Spectra} potentially stepping into more leadership and organizing roles. The PI is also an invited speaker at the 2020 LGBTQ+Math Day. The PI has also founded or organized numerous groups for LGBTQ+ students at the University of Wisconsin. For example, since 2017 she has organized the campus social group for LGBTQ+ graduate students, which has over 350 members. While at Berkeley she plans to be involved in similar organizing efforts. 

The PI has organized a number of conferences including the \textit{Graduate Workshop in Commutative Algebra for Women and Mathematicians of Minority Genders} (2019), a workshop brining together algebraic geometers and number theorists \textit{Geometry \& Arithmetic of Surfaces} (2019), and a five day conference dedicated to developing open source computer software for algebraic geometry and commutative algebra \textit{M2@UW} (2018). Going forward the PI plans to organize a follow-up to \textit{Graduate Workshop in Commutative Algebra for Women and Mathematicians of Minority Genders} tentatively planned for Spring 2021, as well as, a conference for LGBTQ+ mathematicians in algebraic geometry and commutative algebra. 
