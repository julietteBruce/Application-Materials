...
\textbf{Overview} The PI proposes to study questions in commutative algebra, algebraic geometry, and arithmetic geometry. More specifically the PI has proposed the following projects:
\begin{enumerate}
\item 
\end{enumerate}
...
\textbf{Broader Impacts} As a LGBTQ women the PI has worked hard to promote diversity, inclusivity, and justice in the mathematical community. She has organized four conferences including a conference aimed at women and mathematicians of minorty genders in commutative algebra. She is also organizing a panel at the Joint Math Meetings discussing the challenges faced by transgender students. 


Going forward the PI plans to continue her wok in these directions. In particular, there are plans to ogranize a follow-up to GWCAWMMG and a conference for LGBTQ+ mathematicians in algebraic geometry and commutative algebra. 
