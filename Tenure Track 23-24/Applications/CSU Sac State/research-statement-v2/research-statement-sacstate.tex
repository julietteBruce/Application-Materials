...
The methods behind  Goal Theorem~\ref{goalThm:agm} show new connections between the cohomology of $\cA_{g}(m)$ and the cohomology of $\GL_{g}(\Z)(m)$. The cohomology of $\Sp(2g,\Z)(m)$ -- and hence  $\cA_{g}(m)$ -- and $\GL_{g}(\Z)(m)$ are closely connected to automorphic forms. It is natural to wonder whether our methods for computing the top-weight cohomology of $\cA_{g}(m)$ shed new light on automorphic forms. In an ongoing conversation with, Melody Chan, and Peter Sarnak I hope to address this question.
