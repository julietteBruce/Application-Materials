...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{Application Deadlines}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{itemize}

\item October 16 -- NSF Postdoctoral Research Fellowships (FastLane)

\item November 1 -- Max Planck Institute for Mathematics in the Sciences (MathJobs)
	\begin{itemize}
		\resitem{Prefers applications as soon as possible. }
	\end{itemize}
