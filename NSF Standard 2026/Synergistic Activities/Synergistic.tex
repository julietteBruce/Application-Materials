...
\begin{itemize}
   \item \textbf{Research Conference Organizing:} The PI has organized many national research conferences and workshops. Most recently the PI was a co-organizer for the Fall 2024,  \textit{Algebraic Geometry Northeastern Series (AGNES)}, a weekend conference with ~100 participants held at Dartmouth College aimed at introducing early career researchers (e.g. graduate students and postdocs) to current research trends in algebraic geometry and related fields. 
    ...
    \vspace{.2 cm}
        ...
        \item \textbf{Invited Research Talks:} The PI has given many invited research talks including giving a plenary talk \textit{Homological Algebra Beyond Projective Space} at $\Spec(\overline{\mathbb{Q}}(2\pi i))$ a research conference held a the Fields Institute. 
            
        \vspace{.2 cm}

   \item \textbf{Preparing Future Researchers} The PI has organized and lead numerous initiatives and conferences aimed at helping graduate students and early career researchers establish themselves within the field, find research mentors, and a community of collaborators. Of note is the \textit{Gems Of...} series of weekend and week-long workshops that the PI organized, with NSF support, for young researchers in commutative algebra and combinatorics. This series has reached over 150+ participants over 3 years. 
   
    \vspace{.2 cm}
    
    \item \textbf{Growing the Mathematics Community}  The PI served as the inaugural president for \textit{Spectra}, aimed at widening the mathematical community. This included growing the organization's budget by \$20,000 and its membership to over 500 people, and launching the organization's annual invited lecture series at the Joint Mathematics Meeting.
