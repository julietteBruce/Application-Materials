...
\noindent \textbf{Overview} The PI proposes to study questions in commutative algebra, algebraic geometry, and arithmetic geometry. On project proposal seeks to study homological questions in commutative algebra and algebraic geometry from an asymptotic prospect, and involves interplay with high performance computing and numerical linear algebra. 

\noindent \textbf{Intellectual Merit.} The PI's first project seeks to expand our understanding of syzygies of algebraic varieties by 
