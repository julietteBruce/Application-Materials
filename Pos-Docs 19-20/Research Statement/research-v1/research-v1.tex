...
My research interests lie in algebraic geometry, commutative algebra, and algebraic geometry. In particular, I am interest i using homological, combinatorial, and explicit methods to study the geometry of zero locus of systems of polynomials, that is the geometry of algebraic varieties, over both fields of characteristic zero and $p>0$. 
...
Given a projective variety $X$ embedded in $\P^r$, we associate to $X$ the ring $S_X=S/I_X$, where $S=\C[x_0,\ldots,x_r]$ and $I_X$ is the ideal of homogenous polynomials vanishing on $X$. As $S_X$ is naturally a graded $S$-module we may consider its minimal free resolution. The minimal graded free resolution of $X$ is often closely related to both the extrinsic and intrinsic geometry of $X$.  As example of this phenomena, consider the following theorem, a special case of Green's Conjecture \cite{avramov_lectutres_2011}. 
...
In his pioneering papers \cite{green84-I}, \cite{green84-II} initiated the study of the relationship between syzygies of an algebraic variety $X\subset \P^r$ and properties of the embedding line bundle. While Green did not frame his results in this way, in recent years, it has become clear that one useful framework to study this relationship is that of asymptotic syzygies. Asymptotic syzygies is the study of the graded Betti numbers of a variety as the positivity of the embedding grows.

In order to give a flavor of the results of asymptotic syzygies precisely, following the notation of \cite{ermanYang18}, set
\begin{align*}
...
Over an infinite field a Noether normalization states that if $X\subset \P^r$ is a projective variety of dimension $n$ then there exists a finite (i.e. surjective with finite fibres) map $X\arrow \P^n$. The existence of such a map is equivalent to the existence of a collection of homogenous polynomials $f_{0},\ldots,f_{n}$ such that $X\cap \V(f_{0},\ldots,f_{n})=\o$. Such a collection of polynomials is called a system of parameters. 
