...
A projective variety $X\subset \P^n$, is defined by a homogenous ideal $I_{X}$ in the standard $\Z$-graded polynomial ring. The minimal graded free resolution of $I_{X}$ often captures not only interesting algebraic information about the defining equations of $X$, but also infromation about the geometry of $X$. When $\P^{n}$ is replaced by another toric variety $X$ the ways minimal multigraded free resolutions over the Cox ring of $X$ capture algebraic and geometric information is often quite mysterious. Much of my recent work has focused on developing tools in multigraded homological algebra to better understand the geometry of toric varieties. As a taste of this I will focus on my work studying the connection between minimal resolutions and multigraded Castelnuovo–Mumford regularity.
