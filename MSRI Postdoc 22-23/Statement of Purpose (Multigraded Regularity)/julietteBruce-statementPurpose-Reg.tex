...
A projective variety $X\subset \P^n$, is defined by a homogenous ideal $I_{X}$ in the standard $\Z$-graded polynomial ring $\C[x_0,\ldots,x_n]$. The minimal graded free resolution of $I_{X}$ often captures not only interesting algebraic information about the defining equations of $X$, but also captures various things about the extrinsic and intrinsic geometry of $X$. When $\P^{n}$ is replaced by another toric variety $X$ the ways minimal multigraded free resolutions over the Cox ring of $X$ capture algebraic and geometric information about subvarieties of $X$ remains quite mysterious. Much of my recent work has focused on developing tools in multigraded homological algebra to better understand the geometry of toric varieties. As a taste of some of this work I will focus on recent work studying the homological properties of multigraded Castelnuovo–Mumford regularity.
...
With my collaborators, I was able to find examples showing that generalizing Theorem~\ref{thm:eisenbud-goto} to mulitgraded regularity is quite subtle. For example, the multigraded Betti numbers of a module do not determine multigraded Castelnuovo--Mumford regularity, and there exists a finitely generated module $M$ that is $\dd$-regular, but where the truncation $M_{\geq\dd}$ does not have a linear free resolution. However, we show that multigraded regularity can be characterized by the truncation $M_{\geq \dd}$ having a certain type of free resolution, which generalizes the notion of a linear resolutions. 
