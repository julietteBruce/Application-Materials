...
Working with David Eisenbud would provide me with the opportunity to learn from one of the foremost experts in algebraic geometry and commutative algebra. Further, Eisenbud's research interests are extremely well aligned with mine. In particular, he has done substantial work concerning the syzygies of algebraic varieties, liaison theory, and the geometry of curves. This means that working with him would likely prove valuable towards Questions~\ref{quest:semi-ample}\ref{quest:virtual-rao}, and Goal Theorem~\ref{goalTheorem:virtualACM}. In short I believe working with David Eisenbud would advance my research career. 
