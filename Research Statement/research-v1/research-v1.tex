...
While the liaison theory of curves in $\P^3$ is well understood the same theory for curves in other 3-folds (even $\P^1\times\P^2$) remains quite mysterious. One reason for this stark difference is that the minimal graded free resolution of curves in $\P^3$ are much simpler and better understood than resolutions of curves on other 3-folds.. For example, classical theorems implies that every curve in $\P^3$ has a minimal graded free resolution of length at most 3, while in for curves in $\P^1\times \P^2$ the minimal graded free resolution may have length up to 4. 
...
In order to explore these questions we have computed a number of examples of curves in $\P^1\times\P^2$ 
...
Building upon Poonen's work Daniel Erman and I examined when collections of polynomials over a finite field form a (partial) system of parameters. That is when a the zero locus of a set of polynomials has the correct degree. By adapting  
